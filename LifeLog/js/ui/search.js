...
function applySearchFromState() {
    ...
    if (opts.keyword1 || opts.keyword2) {
        result = result.filter(ev => {
            ...
            // キーワード1条件
            const k1 = opts.keyword1
                ? text.includes(opts.keyword1)
                : true;

            // キーワード2条件
            const k2 = opts.keyword2
                ? text.includes(opts.keyword2)
                : true;
